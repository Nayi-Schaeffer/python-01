...
if recipe_to_spanish in recipes:
    print(f"Si esta la receta de {recipe_to_spanish}")
    print(f"La receta es {recipes[recipe_to_spanish]}")

else:
    print(f"Receta de {recipe_to_spanish} no fue encontrada")
